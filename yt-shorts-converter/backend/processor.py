"""
YouTube Long Video to Shorts Converter
B.Tech AI Project - 6th Semester
-----------------------------------------
100% FREE Stack:
  1. yt-dlp          -> Download YouTube video (free)
  2. Whisper (local) -> Transcribe audio on your machine (free, no API)
  3. Groq API        -> LLaMA-3 to find key segments (free tier, very fast)
  4. FFmpeg + OpenCV -> Cut, crop, overlay captions, export (NO ImageMagick needed)
"""
...
# ── Auto-load .env file from the backend/ folder ──────────────────────────────
